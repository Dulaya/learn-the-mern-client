        ...
        <div style={containerStyle}>
          ...
          <Navbar style={{ fontSize: '1.25rem' }} bg="light" expand="lg">
            ...
            <Navbar.Collapse id="basic-navbar-nav">
              <Nav>
                <Link style={{ margin: '0 10px' }} to='/lesson'>lesson</Link>
              </Nav>
              <Nav>
                <Link style={{ margin: '0 10px' }} to='/forum'>Forum</Link>
              </Nav>
            </Navbar.Collapse>
          </Navbar>
          ...
          <Route exact path='/'>
            <Container>
              <CardDeck>
                <Card>
                  <Link to='/lesson'>
                    <Card.Img variant="top" src="https://stackify.com/wp-content/uploads/2018/10/JavaScript-Tutorials-for-Beginners-1280x720.jpg" />
                    <Card.Body>
                ...
                <Card>
                  <Link to='/login'>
                    <Card.Img variant="top" src="https://spwww.sccpss.com/schools/rc/PublishingImages/login.jpg" />
                    <Card.Body>
